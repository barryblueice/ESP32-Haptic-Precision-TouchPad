...
const uint8_t mouse_hid_report_descriptor[] = {
    ...
    // Keyboard: Report ID 8, modifiers, reserved, six key usages; no LED output.
    0x05, 0x01, 0x09, 0x06, 0xa1, 0x01, 0x85, 0x08,
...
uint8_t ptp_hid_report_descriptor[] = {
    ...
    0xb1, 0x02,                         // FEATURE (Data,Var,Abs)
    // Standard controls share configuration with Manager: the last successful
    // write wins, including Windows preferences sent on reconnect. Keep the
    // existing Report IDs and byte ranges for configurator compatibility.
    ...
    // Haptic intensity under the same Touch Pad application collection.
    ...
    0xB1, 0x02,                         // Feature(Data,Var,Abs)
    0xC0,                               // EndCollection (Simple Haptic Controller)
    0xC0,                               // END_COLLECTION
