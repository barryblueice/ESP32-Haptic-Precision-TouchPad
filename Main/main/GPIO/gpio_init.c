...
void gpio_init(void) {
    ...
    ESP_ERROR_CHECK(gpio_set_level(GPIO_HAPTIC_BUCK_BOOST_EN, EN_OFF));
    ESP_ERROR_CHECK(gpio_config(&mp28167_io_conf));
    ...
    ESP_ERROR_CHECK(gpio_config(&vbus_det_conf));
