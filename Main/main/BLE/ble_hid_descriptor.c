...
const uint8_t ble_mouse_hid_report_descriptor[] = {
    ...
    0x81, 0x03,        //     Input (Cnst, Var, Abs) - 5bit Padding
    0x05, 0x01,        //     Usage Page (Generic Desktop)
    0x09, 0x30,        //     Usage (X)
    0x09, 0x31,        //     Usage (Y)
    ...
    0xC0,              //   End Collection
    0xC0,              // End Collection
    // Surface strength, available in native mouse mode as well.
    0x06, 0x00, 0xFF, 0x09, 0x41, 0xA1, 0x01,
    0x85, REPORTID_HAPTIC_INTENSITY, 0x09, 0x41,
