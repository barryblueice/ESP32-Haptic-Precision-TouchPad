...
#define LEGACY_EPNUM_TP_IN    0x83
#define EPNUM_MOUSE_IN        0x84

#define CONFIG_TOTAL_LEN  (TUD_CONFIG_DESC_LEN + 4 * TUD_HID_DESC_LEN)

const uint8_t generic_hid_report_descriptor[] = {
    TUD_HID_REPORT_DESC_GENERIC_INOUT(64)
};

#if CONFIG_LAST_GEN_DESC
...
#else
#define LOGICAL_X  0x26, 0xFA, 0x08
#define LOGICAL_Y  0x26, 0xFC, 0x05
#define PHYSICAL_X 0x46, 0x7D, 0x04
#define PHYSICAL_Y 0x46, 0xFE, 0x02
#define PHYSICAL_UNIT_EXPONENT 0x55, 0x0E
...
const uint8_t legacy_ptp_hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                         // COLLECTION (Application)
    0x85, REPORTID_LEGACY_TOUCHPAD,     // REPORT_ID (Touch pad)
    ...
    PHYSICAL_UNIT_EXPONENT,             // UNIT_EXPONENT
    ...
    0x85, REPORTID_LEGACY_PTPHQA,       // REPORT_ID (PTPHQA)
    ...
    0xa1, 0x01,                         // COLLECTION (Application)
    0x85, REPORTID_LEGACY_FEATURE,      // REPORT_ID (Feature)
    0x09, 0x22,                         // USAGE (Finger)
    0xa1, 0x02,                         // COLLECTION (logical)
...
const uint8_t haptic_ptp_hid_report_descriptor[] = {
    ...
    0x09, 0x05,                         // USAGE (Touch Pad)
    0xa1, 0x01,                         // COLLECTION (Application)
    0x85, REPORTID_HAPTIC_TOUCHPAD,     // REPORT_ID (Touch pad)
    ...
    0xb1, 0x02,                         // FEATURE (Data,Var,Abs)
    0x06, 0x00, 0xff,                   // USAGE_PAGE (Vendor Defined)
    0x85, REPORTID_HAPTIC_PTPHQA,       // REPORT_ID (PTPHQA)
    0x09, 0xC5,                         // USAGE (Vendor Usage 0xC5)
    0x15, 0x00,                         // LOGICAL_MINIMUM (0)
    0x26, 0xff, 0x00,                   // LOGICAL_MAXIMUM (0xff)
    0x75, 0x08,                         // REPORT_SIZE (8)
    ...
    0x09, 0x0E,                         // USAGE (Configuration)
    0xa1, 0x01,                         // COLLECTION (Application)
    0x85, REPORTID_HAPTIC_FEATURE,      // REPORT_ID (Feature)
    0x09, 0x22,                         // USAGE (Finger)
    0xa1, 0x02,                         // COLLECTION (logical)
    0x09, 0x52,                         // USAGE (Input Mode)
    0x15, 0x00,                         // LOGICAL_MINIMUM (0)
